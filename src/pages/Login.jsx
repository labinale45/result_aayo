  ...
  <div className="sm:w-1/2 px=18">
        ...
        <form onSubmit={signIn} className="flex-col gap-2">
          <input 
            ...
            required
          /> <FaRegCircleUser className="absolute top-[40%] left-[44%] size-7"/><br/>  
          <input 
            className="txt p-3 mt-8 w-72 rounded-xl border " 
            type="password"
          ...
          <div className="text-white ml-4"><input type="checkbox" className="size-5 mt-5 mr-4 text-white" />Show password</div>
